...
(function (g) {
  ...
  var T = {
    ...
    'apply.title': { ko: '접수 방법', my: 'စာမေးပွဲလျှောက်ထားနည်း လမ်းညွှန်', en: 'How to apply' },
    ...
    'rules.title': { ko: 'TOPIK 규정', my: 'TOPIK စည်းမျဉ်းများ', en: 'TOPIK rules' },
    'rules.notice': { ko: '유의 사항', my: 'သတိပြုရန် အချက်များ', en: 'Important notes' },
    'rules.answer': { ko: '답안 작성 요령', my: 'အဖြေလွှာဖြည့်သွင်းနည်း လမ်းညွှန်', en: 'Answer sheet guide' },
    'rules.fee': { ko: '응시료 규정', my: 'စာမေးပွဲကြေးဆိုင်ရာ စည်းမျဉ်း', en: 'Fee policy' },
    ...
    'foot.desc': {
      ...
      my: 'ကိုရီးယားဘာသာအရည်အချင်းစစ်စာမေးပွဲ (TOPIK) မြန်မာနိုင်ငံဆိုင်ရာ တရားဝင်သတင်းအချက်အလက်နှင့် လျှောက်လွှာတင်သည့် ဝက်ဘ်ဆိုက်ဖြစ်သည်။<br>ကျင်းပရေး <strong>မြန်မာနိုင်ငံရှိ ကိုရီးယားသံရုံး</strong>',
    ...
    'foot.menu': { ko: '바로가기', my: 'အမြန်လင့်ခ်များ', en: 'Quick links' },
    'foot.ext': { ko: '외부 링크', my: 'ပြင်ပလင့်ခ်များ', en: 'External links' },
    ...
    'menu.rules': { ko: 'TOPIK 규정', my: 'TOPIK စည်းမျဉ်းများ', en: 'TOPIK rules' },
    ...
    'sub.apply_howto': { ko: '접수 방법', my: 'စာမေးပွဲလျှောက်ထားနည်း', en: 'How to apply' },
    ...
    'go.lead': { ko: '한국어능력시험(TOPIK)의 정의·목적과 시행 기관, 응시 자격을 안내합니다.', my: 'ကိုရီးယားဘာသာ အရည်အချင်းစစ်စာမေးပွဲ(TOPIK) ၏ အဓိပ္ပာယ်သတ်မှတ်ချက်၊ ရည်ရွယ်ချက်၊ ကျင်းပသည့်အဖွဲ့အစည်းနှင့် ဖြေဆိုခွင့်အရည်အချင်းတို့ကို လမ်းညွှန်ဖော်ပြပေးထားပါသည်။', en: 'Definition and purpose of TOPIK, the administering bodies, and eligibility.' },
    ...
    'gi.h_uses': { ko: '미얀마 응시자의 주요 활용처', my: 'မြန်မာနိုင်ငံရှိ ဖြေဆိုသူများအတွက် အဓိက အသုံးဝင်ပုံများ', en: 'Key uses for test-takers in Myanmar' },
    'gq.lead': { ko: '영역별 문항 수와 점수 배분, 시험 시간을 안내합니다.', my: 'စာမေးပွဲအပိုင်းအလိုက် မေးခွန်းအရေအတွက်၊ အမှတ်ခွဲဝေမှုနှင့် စာမေးပွဲ အချိန်တို့ကို လမ်းညွှန်ဖော်ပြပေးထားပါသည်။', en: 'Number of questions, score allocation, and test time by section.' },
    'ge.lead': { ko: '등급별 합격 점수, 채점 방식, 성적 인정 기간을 안내합니다.', my: 'အဆင့်အလိုက် အောင်မှတ်များ၊ အမှတ်ပေးစနစ်နှင့် ရမှတ်သက်တမ်းတို့ကို လမ်းညွှန်ဖော်ပြပေးထားပါသည်။', en: 'Passing scores by level, scoring method, and validity period.' },
    ...
    'ge.h_scoring': { ko: '채점 방식', my: 'အမှတ်ပေးစနစ်', en: 'Scoring method' },
    'ge.h_validity': { ko: '성적 인정 기간', my: 'ရမှတ် သက်တမ်း', en: 'Validity period' },
    'ge.h_grading': { ko: '등급 부여 방식', my: 'အဆင့်သတ်မှတ်မှုပုံစံ', en: 'Grading method' },
    'ge.h_report': { ko: '성적표 발급', my: 'ရမှတ်လက်မှတ် ထုတ်ပေးခြင်း', en: 'Score report issuance' },

    /* ── 본문: TOPIK 규정 (rules-*) ── */
    'rn.lead': { ko: '시험 당일 입실·신분 확인·휴대 금지 물품 및 부정행위 규정을 반드시 확인해 주세요.', my: 'စာမေးပွဲကျင်းပမည့်နေ့တွင် စာမေးပွဲခန်းအတွင်း ဝင်ရောက်ခြင်း၊ အထောက်အထား စစ်ဆေးခြင်း၊ ယူဆောင်ခွင့်မပြုသော ပစ္စည်းများနှင့် မသမာမှုဆိုင်ရာ စည်းမျဉ်းများကို သေချာစွာ ဖတ်ရှု စစ်ဆေးပေးပါရန်။', en: 'Check entry, ID verification, prohibited items, and misconduct rules for test day.' },
    'rn.h_entry': { ko: '입실 및 신분 확인', my: 'စာမေးပွဲခန်း ဝင်ရောက်ခြင်းနှင့် အထောက်အထား စစ်ဆေးခြင်း', en: 'Entry and ID verification' },
    ...
    'ra.lead': { ko: 'OMR 마킹·쓰기 답안지 작성법 및 사용 가능한 필기구 안내입니다.', my: 'OMR အဖြေလွှာအမှတ်ခြစ်နည်း၊ ရေးဖြေ အဖြေလွှာ ရေးသားဖြေဆိုနည်းနှင့် အသုံးပြုခွင့်ရှိသော စာရေးကိရိယာများကို လမ်းညွှန်ဖော်ပြထားပါသည်။', en: 'How to mark OMR, complete the writing sheet, and which pens are allowed.' },
    ...
    'ri.lead': { ko: '시험 당일 인정 신분증 종류 및 미소지 시 대응 안내입니다.', my: 'စာမေးပွဲဖြေဆိုမည့်နေ့တွင် ယူဆောင်လာရမည့် သက်သေခံအထောက်အထား အမျိုးအစားများနှင့် ယူဆောင်လာရန် ပျက်ကွက်ပါက လိုက်နာဆောင်ရွက်ရမည့် အချက်များကို လမ်းညွှန်ဖော်ပြပေးထားပါသည်။', en: 'Accepted ID types for test day and what to do if you have none.' },
    ...
    'home.cta_closed': { ko: '접수 마감', my: 'လျှောက်ထားမှု ပိတ်', en: 'Registration closed' },
    'home.cta_full': { ko: '정원 마감', my: 'လူဦးရေ ပြည့်', en: 'Capacity full' },
    'home.full_badge': { ko: '한국어능력시험 정원 마감', my: 'ကိုရီးယားဘာသာ အရည်အချင်းစစ်စာမေးပွဲ လူဦးရေ ပြည့်', en: 'TOPIK capacity full' },
    'home.full': { ko: '정원 마감', my: 'လူဦးရေ ပြည့်', en: 'Capacity full' },
