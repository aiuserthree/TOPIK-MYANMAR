...
| `[x]` | **회원 목록 필터·검색·페이지네이션** | `GET /admin/users` — `page`/`page_size`/`q`/`status`/`nationality`, 정지·탈퇴 포함, `status_counts` 반환 | — (구현 완료) | P1 | [bo-05](services/bo-05-members-terms.md) §2.1·§5 |
