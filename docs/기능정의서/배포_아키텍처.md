...
**작성일:** 2026-06-02 · **갱신:** 2026-06-07  
**상태:** **운영 확정** — IwinV VPS 2대 + FastAPI (`apps/api`) + 테라웹메일 SMTP
...
| BO | `html/C안/BO(admin)/project/` | `https://admin.topik-myanmar.com` |
| API | **FastAPI** `apps/api` — FO/BO 대부분 구현 | 동일 Web VPS — systemd + nginx `/api/` |
| DB | PostgreSQL 로컬 / IwinV DB VPS | `115.68.227.1` — `db/migrations/V001`~`V007` |
